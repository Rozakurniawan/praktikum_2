...
<form method="POST" action="form_registrasi.php">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">E-mail</label> 
    <div class="col-8">
      <input id="nama" name="email" type="email" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="custom-control custom-checkbox custom-control-inline">
        <input name="skill[]" id="skill[]_5" type="checkbox" class="custom-control-input" value="pyton"> 
        <label for="skill[]_5" class="custom-control-label">Pyton</label>
      </div>
      <div class="custom-control custom-checkbox custom-control-inline">
...
<?php
//ambil data yang di inputkan user berdasarkan unik namenya
//fungsi isset() digunakan untuk memeriksa apakah suatu variable sudah diisi & sudah diatur atau belum
